...
def my_playlist():
    ...
    playlist = return_playlist(sp=sp, all_tracks=all_tracks)
    track_names, _ = get_playlist_tracks(sp, playlist)
    return render_template('playlist.html', track_names=track_names, features= {})
...
def handle_data():
    ...
    # TO-DO: Divide ranges as to three parts: 33-33-33
    playlist = return_playlist(sp=sp, all_tracks=all_tracks, **features)
    # TO-DO: Add try-except
    print(playlist)
    track_names, _ = get_playlist_tracks(sp, playlist)
    return render_template('playlist.html', track_names=track_names, features=features)
